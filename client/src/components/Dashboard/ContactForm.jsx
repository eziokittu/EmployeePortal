              ...
              >
                ...
                <div className="mb-4 relative">
                  ...
                  <input
                    ...
                    className="block w-full h-10 mt-1 pl-10 border-2 border-gray-600 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  />
                  <svg
                ...
                <div className='mb-4'>
                  ...
                  <textarea
                    ...
                    className="block p-2 w-full mt-1 border-2 border-gray-600 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  ></textarea>
                </div>
                ...
                <button 
                  ...
                  className="mt-4 px-6 py-3 w-full font-bold bg-blue-500 text-white rounded-md shadow hover:bg-gray-600"
                  >Submit
                </button>
